(function () {
  ...
  var SEED = [
    ...
    ['Rakennus & Saneeraus R. Vainio', 'Rakennusliike', '', '044 074 4229', '', ''],
    ['Rakennus & Saneeraus M. Lomppi', 'Rakennusliike', '', '050 354 3619', '', ''],
    ['Rakennus Talosaari Oy', 'Rakennusliike', '', '', 'none', ''],
    ['LVT-Putki Oy', 'LVI / putki', 'lvt-putki.fi', '02 8378 7070', '', ''],
    ['Putkimies Rauma', 'LVI / putki', 'putkimiesrauma.fi', '', '', 'numero johtaa valtakunnalliseen välityspalveluun'],
    ['Jussin LVI-Asennus Oy', 'LVI / putki', 'jussinlviasennus.fi', '', '', ''],
    ['Eurajoen Kiinteistöpalvelu Oy', 'Kiinteistöhuolto', 'ekp.fi', '044 278 7513', '', ''],
    ['Rauman Rauta- ja Putkirakenne Oy', 'LVI / putki', 'rrpoy.com', '02 822 0822', '', ''],
    ...
    ['Sorcolor', 'Maalaus', 'sorcolor.fi', '010 391 9410', '', 'valtakunnallinen ketju, pääkonttori Helsingissä'],
    ...
    ['Rauman Maalaus ja Rakennushuolto Oy', 'Maalaus', 'raumanmaalaus.fi', '0500 720 836', '', ''],
    ['Maalaus Rantamäki Oy', 'Maalaus', 'maalausrantamaki.com', '', '', ''],
    ['Valttikate', 'Katto', 'valttikate.fi', '', '', ''],
    ['Solarkatto', 'Katto', 'solarkatto.fi', '040 777 3287', '', ''],
    ['Suomen Vahva-Katto Oy', 'Katto', 'vahvakatto.fi', '045 879 8840', '', ''],
    ['Remontti Rauma', 'Katto', 'remonttirauma.fi', '', '', ''],
    ['Auto-Korsman', 'Autokorjaamo', 'auto-korsman.fi', '044 977 7717', '', ''],
    ['Autokorjaamo Karla', 'Autokorjaamo', 'karla.fi', '029 009 8260', '', 'S-ryhmän ketju — päätös ei ole Raumalla'],
    ['Rauman Laatuhuolto Oy', 'Autokorjaamo', 'raumanlaatuhuolto.com', '02 823 5729', '', ''],
    ['Rauman Siivouspalvelu Oy', 'Siivous', 'raumansiivouspalvelu.fi', '040 218 1996', '', ''],
    ['TiiMa Oy', 'Siivous', 'siivousrauma.fi', '045 127 9984', '', ''],
    ['Yrityspalvelut Rauma', 'Siivous', 'yrityspalvelutrauma.fi', '', '', ''],
    ['DiakonSiivous', 'Siivous', '', '044 705 2265', '', ''],
    ['Apukuski Rauma', 'Kuljetus ja muutot', 'apukuski.com', '', '', ''],
    ['JMS-Kuljetus Oy', 'Kuljetus ja muutot', 'jms-kuljetus.fi', '0400 728 091', '', ''],
    ...
    seedBtn.addEventListener('click', function () {
      ...
      SEED.forEach(function (s) {
        ...
        rows.push({
          ...
          // [nimi, toimiala, verkkosivu, puhelin, sivuston tila, huomio]
          ...
          web: s[4] || 'unknown',
          note: s[5] || ((s[2] || s[4]) ? '' : 'sivustoa ei löytynyt haulla'),
          status: 'new'
        });
        added++;
      });
